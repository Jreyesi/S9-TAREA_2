...
class Ejercicio4{
  dsemana(){
    ...
    switch (num1){
      case 1:
        resp.textContent= `El dia ingresado es: DOMINGO`
        break
      case 2:
        resp.textContent= `El dia ingresado es: LUNES`
        break
      case 3:
        resp.textContent= `El dia ingresado es: MARTES`
        break
      case 4:
        resp.textContent= `El dia ingresado es: MIERCOLES`
        break
      case 5:
        resp.textContent= `El dia ingresado es: JUEVES`
          break
      case 6:
        resp.textContent= `El dia ingresado es: VIERNES`
            break
      case 7:
        resp.textContent= `El dia ingresado es: SABADO`
              break
        default:
